...
def run_training():
    ...
    for epoch in tqdm(range(1, args.epochs + 1)):
        ...
        for imgs, targets,aro_true, val_true in tqdm(train_loader):
            ...
            loss =  dloss + 0.1 * criterion_orig + 0.1 * criterion_smirk + 0.05*l3_loss
            loss.backward()
            optimizer.step()
            scheduler.step()
        ...
        with torch.no_grad():
            ...
            if acc > best_acc:
                ...
                }, os.path.join('picture_linear_fusion_va_alignment_checkpoints', "affecnet_epoch_0.05_l3loss" + str(epoch) + "_acc" + str(acc) + ".pth"))
